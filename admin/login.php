			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						?>
						<form method="post" action="sigin_in.php">
							<div class="input-group custom">
								<input type="Email" class="form-control form-control-lg" placeholder="Email" name="email" data-validate = "Valid email is: a@b.c" required>
