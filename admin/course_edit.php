...
<div class="main-container">
                <div class="card-box mb-30">
                    ...
                    <form action="course_update" method="post" enctype="multipart/form-data">
                        <input type="text" name="id" value="<?= $courses['id'] ?>" hidden>
                            <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Course Name</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="coursename" value="<?= $courses['coursename'] ?>" required>
                            </div>
                            </div>
                            <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Description</label>
                            <div class="col-sm-12 col-md-10">
                                <textarea class="form-control" name="description" type="text" required cols="30" rows="10"><?= $courses['description'] ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-10">
