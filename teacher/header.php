				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="../admin/<?= $_SESSION['loginUser']['photo'] ?>" alt="User Profile">
						</span>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						...
						<span class="micon icon-copy fa fa-address-card"></span><span class="mtext">Students</span>
						</a>
					</li>
					<li>
						<a href="booking" class="dropdown-toggle no-arrow">
						<span class="micon icon-copy dw dw-calendar-4"></span><span class="mtext">Class</span>
						</a>
					</li>
					<!-- <li class="dropdown">
