...
if(!isset($_SESSION['loginStudent']))
	  ...
	  $query_classes="SELECT * FROM classes ORDER BY id DESC";
	  $stmt_classes=$conn->prepare($query_classes);
	  $stmt_classes->execute();
	  $class =$stmt_classes->fetchAll();
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<!-- <div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../admin/vendors/images/mark.gif" alt=""></div>
				...
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
							<?php
									foreach(array_slice($class, 0,5) as $classes)
									{
										$id=$classes['id'];
										$name=$classes['class'];
								...
								<li>
									<a href="class">
										<img src="../admin/vendors/images/img4.jpg">
										<h3>New Class</h3>
										<p><b class="text-blue"><?php echo $name?></b> is availabe. About<?php echo $course?> and Lecturer is <b class="text-blue"><?php echo $teacher?></b>. </p>
									</a>
								</li>
								<?php } ?>
							</ul>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name"><?= $_SESSION['loginStudent']['username'] ?></span>
					</a>
